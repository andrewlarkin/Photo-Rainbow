...
namespace WinForms
{
    public partial class AuthForm : Form
    {
        ...
        private Flickr _flickrAccessInstance;
        public AuthForm()
        {
            InitializeComponent();
        }

        public Flickr flickrAccessInstance
        {
            get { return this._flickrAccessInstance; }
            set { this._flickrAccessInstance = value; }
        }
        ...
        private void CompleteAuthButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MainForm.flickrAccessInstance = f;
